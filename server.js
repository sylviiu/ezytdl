...
module.exports = () => new Promise(async res => {
    ...
    const endpoints = [`config.js`, `download.js`, `fetchInfo.js`, `openFolder.js`, `focus.js`, `version.js`, `changelog.js`] // i can't figure out how to make this work with the above line
