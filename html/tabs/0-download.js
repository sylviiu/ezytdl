            ...
            const parseInfo = async () => {
                ...
                if(!info || info.error) {
                    ...
                    const updateMetadata = async (parse) => {
                        ...
                        if(info._cookies) addMetaItem(`fa-cookie-bite`, `Authorization used`, `The app used the account cookie(s) from your browser (sent through the browser connector) to get this information, and will be used for downloading as well.`, `cookie`)
